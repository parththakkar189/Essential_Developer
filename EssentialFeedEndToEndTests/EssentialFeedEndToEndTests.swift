...
//
//  Created by Parth Thakkar on 2024-11-11.
//
...
final class EssentialFeedEndToEndTests: XCTestCase {
    ...
    private func getFeedImageDataResult(file: StaticString = #file, line: UInt = #line) -> FeedImageDataLoader.Result? {
        let testServerURL = feedTestServerURL.appendingPathComponent("73A7F70C-75DA-4C2E-B5A3-EED40DC53AA6/image", conformingTo: .data)
        let loader = RemoteFeedImageDataLoader(
            client: ephemeralClient(file: file, line: line)
        )
        trackForMemoryLeaks(loader, file: file, line: line)
    ...
    fileprivate var feedTestServerURL: URL {
